    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          >
            <div className="w-24 h-24 rounded-2xl border-2 border-[#00D4C8] flex items-center justify-center relative overflow-hidden"
          ...
          >
            <p className="text-[#00D4C8] text-sm font-mono tracking-[0.3em] uppercase mb-1"
          ...
          >
            <div className="flex justify-between text-xs text-[#3A5070] mb-2"
              style={{ fontFamily: "JetBrains Mono, monospace" }}>
              <span>Loading</span>
